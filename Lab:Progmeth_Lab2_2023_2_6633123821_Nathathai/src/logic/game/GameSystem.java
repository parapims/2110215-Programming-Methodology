...
public class GameSystem extends BaseMonkey {
    ...
    public void addApe() {
        Ape a1 = new Ape(200,30,10);
        Ape a2 = new Ape(200,30,10);
        Ape a3 = new Ape(200,30,10);
        getApeContainer().add(a1);
        getApeContainer().add(a2);
        getApeContainer().add(a3);
    ...
    public void removeDeadEntity(ArrayList<BaseMonkey> entityContainer) {
        for(int index = 0;index< entityContainer.size();index++){
            if(entityContainer.get(index).getHp()==0){
                showDeadMessage(entityContainer.get(index),index);
